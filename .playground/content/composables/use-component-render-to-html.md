...
description: Render a Vue component to a static HTML string — useful for MapLibre popups, PDF generation, and any place that takes raw HTML.
name: useComponentRenderToHTML
tags: [render, html, ssr, tooltip, server-render]
---
...
## Quick example — rendering a tooltip body
...
- Server-side: works in Nuxt SSR too, although the typical use case is client-side rendering of HTML to feed to non-Vue libraries (MapLibre popups).
