...
<script setup lang="ts">
	...
	const theme = {
		...
		variants: {
			hasHowItWorks: {
				true: { title: "max-lg:w-fit max-lg:max-w-[calc(100%-3rem)] max-lg:flex-none" },
				false: { title: "max-lg:flex-1 max-lg:max-w-full" }
			}
		}
	};
	...
	const ui = computed(() => tv(theme)({ hasHowItWorks: !!props.howDoesItWork }));
