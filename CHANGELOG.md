...
- **sformfield:** Add kebab-case error prop fallback ([18ee72f](https://github.com/smartpricing/smartness-nuxt-ui/commit/18ee72f))
...
- **smultiselect:** Support clear and virtualize ([34bd643](https://github.com/smartpricing/smartness-nuxt-ui/commit/34bd643))
...
- **calendar:** Allow custom grid, rows, drag from popover, header day number, sticky column or not, locked drop, reveal on drag ([a2d8b1d](https://github.com/smartpricing/smartness-nuxt-ui/commit/a2d8b1d))
...
- **slider:** ⚠️  Wrap SSlider in UFormField ([73f9610](https://github.com/smartpricing/smartness-nuxt-ui/commit/73f9610))
...
- Update nuxtui ([6db4a0c](https://github.com/smartpricing/smartness-nuxt-ui/commit/6db4a0c))
...
- Release v1.7.1 ([ca42a03](https://github.com/smartpricing/smartness-nuxt-ui/commit/ca42a03))
...
- **snavigationmenu:** Classes ([6240a79](https://github.com/smartpricing/smartness-nuxt-ui/commit/6240a79))
...
- Release v1.5.2 ([8f48f0e](https://github.com/smartpricing/smartness-nuxt-ui/commit/8f48f0e))
...
- **truncated-text:** Add tooltipSide prop ([d195079](https://github.com/smartpricing/smartness-nuxt-ui/commit/d195079))
...
- Switch to pnpm for playground too ([1de516d](https://github.com/smartpricing/smartness-nuxt-ui/commit/1de516d))

### 🩹 Fixes

- Logo and slot option ([be3a94a](https://github.com/smartpricing/smartness-nuxt-ui/commit/be3a94a))
- Mobile logo ([a19ba1a](https://github.com/smartpricing/smartness-nuxt-ui/commit/a19ba1a))
- Class for cta ([af66654](https://github.com/smartpricing/smartness-nuxt-ui/commit/af66654))
- Toggle side ([548c83c](https://github.com/smartpricing/smartness-nuxt-ui/commit/548c83c))

### 🏡 Chore

- Update playground lockfile ([d1285ba](https://github.com/smartpricing/smartness-nuxt-ui/commit/d1285ba))

## v1.3.5...main

[compare changes](https://github.com/smartpricing/smartness-nuxt-ui/compare/v1.3.5...main)

### 🩹 Fixes

- Release creation ([65be31a](https://github.com/smartpricing/smartness-nuxt-ui/commit/65be31a))
...
- Release flow ([e35e1cb](https://github.com/smartpricing/smartness-nuxt-ui/commit/e35e1cb))

### 🏡 Chore

- Debug ([08e0aae](https://github.com/smartpricing/smartness-nuxt-ui/commit/08e0aae))
